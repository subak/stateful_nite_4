(function( $ ) {
	 ...
	 */
	{
		 ...
		 */
		_action: function( methodName, options, context ) {
			...
			// or the window
			var convertedName = options ? Str.sub(methodName, [context, options, window]) : methodName,
        ...
        //if ( methodName == "{domains} add" ) { debugger }
	 ...
	 */
	{
      ...
      if ( controllers !== undefined && controllers[fname] !== undefined ) { delete controllers[fname] }
